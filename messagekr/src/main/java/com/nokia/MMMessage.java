...
public class MMMessage implements IMMConstants, Serializable {
    ...
    /**
     * @return the type of the message (Mandatory).
     *
    ...
    /**
     * @return information about the format of the expiry date/time.
     *
     ...
     *
     * 0x80 if the user wants the sender visibility setting to Hide.
     * 0x81 if the user wants the sender visibility setting to Show.
     */
    ...
    /**
     * @return information about the format of the delivery date/time.
     *
